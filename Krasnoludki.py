...
print(f"{'─' * 8} {'─' * 12} {'─' * 12} {'─' * 30}")
for domek in domki:
    print(f"#{domek.indeks:<7} {Drukarnia.formatuj_wspolrzedne(domek.x, domek.y):<12} {domek.preferencja:<12} {Drukarnia.wypisz_sasiadow(domek):<30}")
...
for kopalnia in kopalnie:
    print(f"#{kopalnia.indeks:<7} {Drukarnia.formatuj_wspolrzedne(kopalnia.x, kopalnia.y):<12} {kopalnia.zloze:<12} {kopalnia.pojemnosc:<8} {Drukarnia.wypisz_sasiadow(kopalnia):<30}")
